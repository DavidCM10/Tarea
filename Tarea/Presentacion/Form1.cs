...
namespace Presentacion
{
    public partial class Form1 : Form
    {
        ...
        private void btnregistrar_Click(object sender, EventArgs e)
        {
            ...
            Pedidos objcliente = new Pedidos()
            {
            ...
            {
                int IdPedidoGen = new NegocioPedidos().Registrar(objcliente, out mensaje);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            List<Pedidos> lista = new NegocioPedidos().Listar();

            foreach (Pedidos item in lista)
            {
